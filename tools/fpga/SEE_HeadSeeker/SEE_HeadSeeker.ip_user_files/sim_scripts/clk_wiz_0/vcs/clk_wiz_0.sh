...
#
# Generated by Vivado on Tue Sep 06 16:45:37 -0700 2022
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"$ref_dir/../../../../../YARR_rx/YARR_rx.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"$ref_dir/../../../../../YARR_rx/YARR_rx.gen/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../../YARR_rx/YARR_rx.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../../YARR_rx/YARR_rx.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
