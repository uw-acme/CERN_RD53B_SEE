...
add wave -noupdate -expand -group HSn(top) -radix unsigned -childformat {{{/sim_aurora_lane/u_aurora_rx_lane/gearbox32to66_cmp/u_aligner/offset_pos_temp[1]} -radix unsigned} {{/sim_aurora_lane/u_aurora_rx_lane/gearbox32to66_cmp/u_aligner/offset_pos_temp[0]} -radix unsigned}} -subitemconfig {{/sim_aurora_lane/u_aurora_rx_lane/gearbox32to66_cmp/u_aligner/offset_pos_temp[1]} {-height 15 -radix unsigned} {/sim_aurora_lane/u_aurora_rx_lane/gearbox32to66_cmp/u_aligner/offset_pos_temp[0]} {-height 15 -radix unsigned}} /sim_aurora_lane/u_aurora_rx_lane/gearbox32to66_cmp/u_aligner/offset_pos_temp
...
update
WaveRestoreZoom {25360815403929 fs} {25361784452425 fs}
