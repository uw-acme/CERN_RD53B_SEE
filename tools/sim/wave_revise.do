...
add wave -noupdate -expand -group aligner /sim_aurora_lane/u_aurora_rx_lane/gearbox32to66_cmp/u_aligner/is_synced_reg
add wave -noupdate -expand -group aligner /sim_aurora_lane/u_aurora_rx_lane/gearbox32to66_cmp/u_aligner/offset_sync
add wave -noupdate -expand -group aligner /sim_aurora_lane/u_aurora_rx_lane/gearbox32to66_cmp/u_aligner/offset_sync_reg
add wave -noupdate -expand -group aligner /sim_aurora_lane/u_aurora_rx_lane/gearbox32to66_cmp/u_aligner/is_synced
add wave -noupdate -expand -group aligner /sim_aurora_lane/u_aurora_rx_lane/gearbox32to66_cmp/u_aligner/resync_continue
...
WaveRestoreCursors {{Cursor 1} {126601600000 fs} 0}
...
update
WaveRestoreZoom {126525615913 fs} {127698592592 fs}
